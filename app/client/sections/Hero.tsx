export default function Hero() {
  ...
  return (
    <section className={`bg-[url(/images/bkg-hero.png)]  flex text-white flex-col justify-center items-center bg-cover bg-no-repeat bg-bottom rounded-3xl md:mx-10 mx-4 px-4 ${heightHero}`}>
